...
import vacansy from "./index.module.css";
...
const Vacancy: React.FC<PropsWithChildren> = ({ children }): JSX.Element => {
  ...
  return (
    <main className={vacansy.page}>
      <div className={vacansy.mainHeader}>
        <Button
          sx={{
            padding: "0",
            margin: "0",
          ...
          className={vacansy.returnButton}
          variant="text"
          startIcon={
            <svg
        ...
        <div className={vacansy.section}>
          <h1 className={vacansy.title}>{vacancyObject?.title}</h1>
          <p className={vacansy.date}>Опубликована: {formDate()}</p>
        </div>
        <div className={vacansy.subSection}>
          <ul className={vacansy.tagsList}>
            <li className={vacansy.tag}>
              <Chip className={vacansy.chip} label={vacancyObject?.city} />
            </li>
            <li className={vacansy.tag}>
              <Chip className={vacansy.chip} label="Полная занятость" />
            </li>
            <li className={vacansy.tag}>
              <Chip
                className={vacansy.chip}
                label={
