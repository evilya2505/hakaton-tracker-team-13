  ...
  return (
    <div className={mainStudentInfo.student}>
          ...
          <ul className={mainStudentInfo.mainInfo}>
            ...
            <li className={mainStudentInfo.mainInfoElement}>
              ...
              <ul className={mainStudentInfo.contactsList}>
                <li className={mainStudentInfo.contact}><a className={mainStudentInfo.link} href="/">name@yandex.ru</a></li>
                <li className={mainStudentInfo.contact}><a className={mainStudentInfo.link} href="/">t.me/bestcandidate</a></li>
              </ul>
            </li>
          </ul>
        </div>
      ...
      <ul className={mainStudentInfo.statistics}>
        <li className={mainStudentInfo.statistic} style={{backgroundColor: "#FFF9D3"}}><h3 className={mainStudentInfo.subtitle}>40</h3>откликов</li>
        <li className={mainStudentInfo.statistic} style={{backgroundColor: "#CCC2ED"}}><h3 className={mainStudentInfo.subtitle}>14</h3>тестовых</li>
        <li className={mainStudentInfo.statistic} style={{backgroundColor: "#C2E5CE"}}><h3 className={mainStudentInfo.subtitle}>10</h3>собеседований</li>
      </ul>
    </div>
  );
}
